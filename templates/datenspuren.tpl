...
<div class="episode">
  ...
  <div style="clear:both;margin:0em auto;max-width:70%;padding-left:20%;height:300px">
    <div class="screen pane" style="float:left">
      <img src="{{episode.preview and episode.preview.static or '/img/empty_screen.jpg'}}" preview="{{episode.preview and episode.preview.animated or '/img/empty_screen.jpg'}}" width="360" height="270" class="screen" />
    </div>
