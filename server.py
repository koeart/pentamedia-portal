...
Episode = model('Episode', name='string', category='string', author='string', date='datetime', short='text', long='text')
...
Episode(name="Rechtsstaat", category="cast", author="kl0bs", date=datetime(2010,4,4,16,14), short=short, long=long).save()
...
Episode(name="No, No, NoSQL, oder doch?", category="radio", author="a8", date=datetime(2010,3,23,13,28), short=short, long=long).save()
...
Episode(name="Zoe.LeelA", category="music", author="koeart", date=datetime(2010,3,18), short=short, long=long).save()
...
Episode(name="Echtzeit-Audio", category="cast", author="kl0bs", date=datetime(2010,3,3,22,23), short=short, long=long).save()
